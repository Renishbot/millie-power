...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⌬ update ⌬', url='https://t.me/millie_robot_update')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɴᴇxᴛ', callback_data='czdbots')    
        ], [
        ...
        buttons = [[
             ...
             InlineKeyboardButton('ɴᴇxᴛ', callback_data='czdbotss')  
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/millie_robot_update'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/millie_robot_update'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/millie_robot_update')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='czdbots')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
